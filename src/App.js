...
function App() {
  ...
  return (<>
    <navbar id="navbar">
      ...
      { show == 0 && ((style.background = "rgb(69, 69, 226"), <ComposeTeam  errors1={errors1} setErrors1={setErrors1} setShow={setShow} Playerlist={Playerlist} setPlayerlist={setPlayerlist} data={data} setdata={setdata}/>)}
